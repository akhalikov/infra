...
/**
 * A {@link javax.sql.DataSource} that sends PostgreSql statement timeout query after obtaining a connection
 ...
 * and all subsequent queries are bounded by the timeout.
 *
 * Do not use in front of other connection pools such as PgBouncer,
 * because the timeout can affect other applications that share the same PgBouncer.
 */
