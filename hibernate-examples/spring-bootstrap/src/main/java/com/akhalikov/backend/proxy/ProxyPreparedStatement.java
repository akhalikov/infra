...
class ProxyPreparedStatement implements PreparedStatement {
  ...
  ProxyPreparedStatement(PreparedStatement preparedStatement, String dataSourceName) {
  ...
  public ResultSet executeQuery() throws SQLException {
    try {
      ...
      throw new SQLException(
          String.format("error in connection %s [readOnly=%b, dataSource=%s]",
              getConnection(), getConnection().isReadOnly(), dataSourceName), e);
    }
  }
